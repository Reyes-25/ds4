<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Laboratorio16._1.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="cal">
            <asp:Label ID="l" Text="CALCULADORA BÁSICA" runat="server" style="margin-left: 50px"
                Font-Bold="true" Font-Italic="true" ForeColor="White" Font-Size="25px"></asp:Label>
